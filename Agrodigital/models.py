...
# inicio dimension "Uso de Tecnologías digitales"
    ...
    choices1 =  (("1", "1-. Las desconozco"), ("2", "2-. algo de conocimiento"), ("3", "3 -.intermedio"), ("4", "4-."), ("5", "5-. las conozco muy bien"))
    ...
    choices2 = (("1", "1-. poco factible"), ("2", "2-."), ("3","3-."), ("4", "4-."), ("5", "5-. muy factible"))
    ...
    choices3 = (("1", "1-. poco o nada"), ("2", "2-. se implementará en algun momento"), ("3","3-."), ("4", "4-. usualmente las utilizamos "), ("5", "5-. siempre los utilizamos"))
...
# inicio dimension "Planificacion estrategica"
    ...
    choices4 = (("1", "1-. Mala disposición"), ("2", "2-. "), ("3", "3 -.intermedio"), ("4", "4-."), ("5", "5-. muy dispuesta"))
    ...
    choices5 = (("1", "1-. poco o nada "), ("2", "2-. "), ("3", "3 -.intermedio"), ("4", "4-."), ("5", "5-. acceso a créditos"))
    p2_dim2 = models.CharField(" 2-. ¿Qué nivel de acceso tiene la empresa a la banca formal?",max_length=1, choices=choices5)

    choices6 = (("1", "1-. Mala disposición"), ("2", "2-. "), ("3", "3 -.intermedio"), ("4", "4-."), ("5", "5-. siempre"))
    ...
    choices7 = (("1", "1-. muy poco o nada"), ("2", "2-. "), ("3", "3 -.medianamente"), ("4", "4-.casi siempre"), ("5", "5-. siempre"))
    ...
    choices8 = (("1", "1-. muy poco o nada"), ("2", "2-. "), ("3", "3 -.medianamente"), ("4", "4-.casi siempre"), ("5", "5-. siempre"))
    p5_dim2 = models.CharField(" 5-. En que grado ha incorporado programas o aplicaciones ",max_length=1, choices=choices8)


    choices9 = (("1", "1-. muy poco o nada"), ("2", "2-. "), ("3", "3 -.medianamente"), ("4", "4-.casi siempre"), ("5", "5-. siempre"))
...
# inicio dimension "Procesamiento de datos"
    ...
    choices10 = (("1", "1-. muy poco o nada"), ("2", "2-. "), ("3", "3 -.medianamente"), ("4", "4-.casi siempre"), ("5", "5-. siempre"))
    p1_dim3 = models.CharField(" 1-. ¿ En que grado hacen una recolaccion de datos sobre sus actividades ? ", max_length=1, choices=choices10)

    choices11 = (("1", "1-. muy poco o nada"), ("2", "2-. "), ("3", "3 -.medianamente"), ("4", "4-.casi siempre"), ("5", "5-. siempre"))
    p2_dim3 = models.CharField(" 2-. ¿ En que grado se analizan los datos para mejorar en el mercado ?", max_length=1,choices=choices11)

    choices12 = (("1", "1-. muy poco o nada"), ("2", "2-. "), ("3", "3 -.medianamente"), ("4", "4-.casi siempre"), ("5", "5-. siempre"))
    p3_dim3 = models.CharField(" 3-. ¿ Consultan datos externos para posicionarse en el mercado ?", max_length=1,choices=choices12)

    choices13 = (("1", "1-. muy poco o nada"), ("2", "2-. "), ("3", "3 -.medianamente"), ("4", "4-.casi siempre"), ("5", "5-. siempre"))
